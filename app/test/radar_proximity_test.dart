...
void main() {
  test('não anuncia nada quando não há radar perto', () {
    ...
    final longe = RadarPoint(lat: -23.0, lon: -44.0);
  ...
  test('anuncia o radar dentro do raio de aviso', () {
    ...
    final perto = RadarPoint(lat: -22.9, lon: -43.1);
  ...
  test('anuncia o radar mais próximo quando há mais de um dentro do raio', () {
    ...
    final maisPerto = RadarPoint(lat: -22.9005, lon: -43.1);
    final maisLonge = RadarPoint(lat: -22.910, lon: -43.1);
